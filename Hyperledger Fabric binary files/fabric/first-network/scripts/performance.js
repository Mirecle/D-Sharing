...
const totalTransactions = 100; // Total number of transactions to be sent
const parallelClients = 10; // Number of parallel transactions to simulate concurrent clients

async function createCar(contract,carNumber) {
...
async function main() {
    ...
    try {
        ...
        for (let i = 0; i < totalTransactions; i++) {
            ...
            promises.push(createCar(contract,i));
        }
        await Promise.all(promises);
