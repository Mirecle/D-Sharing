...
$FABRIC_ROOT/.build/bin/configtxgen -configPath ./ -outputBlock ./channel-artifacts/genesis.block -profile TwoOrgsOrdererGenesis -channelID ${CHANNEL}-system-channel
$FABRIC_ROOT/.build/bin/configtxgen -configPath ./ -outputCreateChannelTx ./channel-artifacts/channel.tx -profile TwoOrgsChannel -channelID ${CHANNEL}
$FABRIC_ROOT/.build/bin/configtxgen -configPath ./ -outputAnchorPeersUpdate ./channel-artifacts/anchor_peer.tx -profile TwoOrgsChannel -asOrg Org1MSP -channelID ${CHANNEL}
